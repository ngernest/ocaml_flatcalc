...
type expr_ref = ExprRef of int [@@unboxed] [@@deriving sexp]

type expr = Binary of binop * expr_ref * expr_ref | Literal of int
[@@deriving sexp]
...
let rec gen_expr (expr_pool : expr_pool) (lit_prob_inv : int) :
  expr_ref Generator.t =
